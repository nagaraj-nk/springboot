...
public class Java8Application {
    ...
    public static void main(String[] args) throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        // comparator();
        // lambda2();
        // functionalInterface(() -> System.out.println("hello functionalInterface"));
        // methodReference();
        System.out.println(squareLazy(() -> 5.6));
    }

    static double squareLazy(Supplier<Double> lazyValue) {
    ...
    private static void methodReference() {
        ...
        Function<String, String> additionalQuote = s -> "additional quote: " + s;
        Function<Integer, String> quoteIntToString = additionalQuote.compose(quote.compose(intToString));
        System.out.println(quoteIntToString.apply(5));
    }


    private static void functionalInterface(TestInterface testInterface) {
        System.out.println(TestInterface.testDefault());
        List<String> integers = new ArrayList<>();
        integers.add("7");
        integers.add("4");
        System.out.println(integers.stream().mapToDouble(Double::parseDouble)
